...
frames += get_metadata(authtoken, start=start, end=end, INSTRUME='en06', PROPID='OGG_calib', RLEVEL=0)  # FTN standard star spectra
frames += get_metadata(authtoken, start=start, end=end, INSTRUME='en05', PROPID='COJ_calib', RLEVEL=0)  # FTS standard star spectra
frames += get_metadata(authtoken, start=start, end=end, INSTRUME='en12', PROPID='COJ_calib', RLEVEL=0)  # FTS standard star spectra
