...
if __name__ == "__main__":
                ...
                if o in listatemp[f]:
                    ...
                    for imgtarg_path in imglist1:
                        ...
                        if not os.path.isfile(_dirtemp + tempnoise0):
                            ...
                            pssl_temp = 0
                            print(_dirtemp, 'path to tempnoise.fits')
    ...
    #                        try:
                        ...
                        if args.difftype == 0:
                            ...
                            print line
                            print(imgtarg, imgtemp, tempnoise, 'what are the images we need' )
                            os.system(line)
                        ...
                        if dictionary['filepath']:
                            print(dictionary['filepath'],'test este 1')
