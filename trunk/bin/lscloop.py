...
if __name__ == "__main__":   # main program
    ...
    parser.add_argument("--bkg", default=4., type=float, help='length of square for background fit in units of PSF FWHM')
    parser.add_argument("--size", default=7., type=float, help='size of the stamp for the fit in units of PSF FWHM')
    ...
    if ll:
        if args.stage != 'merge':
            ...
            for i in range(0, len(ll['filename'])):
                try:
                    print('%s\t%12s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s' % (ll['filename'][i].replace('.fits', ''), ll['objname'][i], ll['filter'][i],
            ...
            if args.standard:
                ...
                for i in range(len(mm['filename'])):
                    print('%s\t%12s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s' % (str(mm['filename'][i]), str(mm['objname'][i]), str(mm['filter'][i]),
    ...
    # ################################################
            ...
            for epo in np.unique(ll['dayobs']):
                ...
                for i in range(0, len(ll0['filename'])):
                    print('%s\t%12s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s\t%9s' % (str(ll0['filename'][i]), str(ll0['objname'][i]), str(ll0['filter'][i]), str(ll0['wcs'][i]),
                           str(ll0['psf'][i]),
