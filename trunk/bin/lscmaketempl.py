    ...
    for fil in imgdic:
        ...
        for img0 in imglist1:
            ...
            if goon:
                ...
                #######################  chose mag  ##############
                if chosemag:
                        _magobj = input('which is the mag of the object  ? ' +str(_mag) + '? ')
                        if _magobj == '':
                            _magobj = _mag
                        else:
                ...
                if chosepos:
                    ...
                    _xpos, _ypos = xytargets[0].split()[0], xytargets[0].split()[1]
                    goon = True
                else:
            ...
            if goon:
                ...
                print(img0, psfimg)
                imgout = re.sub('.fits', '.temp.fits', img0.split('/')[-1])
                ...
                while answ == 'n':
                    ...
                    if answ == 'n':
                        ...
                        _mag0 = input('which magnitude  ' + str(_mag) + ' ?')
                        if _mag0:
                            _mag = _mag0
                ...
                ###################    insert in photlco
                ggg = lsc.mysqldef.getfromdataraw(conn, 'photlco', 'filename', imgout.split('/')[-1], '*')
                if ggg and _force:
                    lsc.mysqldef.deleteredufromarchive(imgout.split('/')[-1], 'photlco', 'filename')
                if not ggg or _force:
                    ...
                    for voce in ggg[0].keys():
                        ...
                        if voce in dictionary.keys():
                            lsc.mysqldef.updatevalue('photlco', voce, dictionary[voce], imgout.split('/')[-1])
