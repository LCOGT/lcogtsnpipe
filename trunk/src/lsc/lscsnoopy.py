##########################        DEFINE FITSN  #########################################
def fitsn(img,imgpsf,coordlist,_recenter,fwhm0,original,sn,residual,_show,_interactive,z11='',z22='',midpt='',size=7,apco0=0,dmax=51000):
    import lsc
...
###################   DEFINE ERROR     ######################################
def errore(img,imgpsf,coordlist,size,truemag,fwhm0,leng0,_show,_interactive,_numiter,z11,z22,midpt,nax,nay,xbgord0,ybgord0,_recenter,apco0,dmax=51000):
    import lsc
    ...
    while i<=8:
        ...
        for ii in range(0,_numiter):
            ...
            artap1, artap2, artap3, artmag1, artmag2, artmag3, artfitmag, arttruemag, artmagerr, artcentx, artcenty = \
                fitsn(img,imgpsf,coordlist,_recenter,fwhm0,'reserr','artsn','artres',_show,_interactive,z11,z22,midpt,size,0,dmax)
####### 
        if i==0: era='yes'
        else:    era='no'
        artx = .5+.25*artx
