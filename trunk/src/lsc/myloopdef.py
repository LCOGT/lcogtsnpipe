...
def display_subtraction(img):
    ...
    if os.path.isfile(diffimg) and os.path.isfile(origimg) and os.path.isfile(tempimg):
        ...
        plt.clf()
        ax1 = plt.subplot(2, 2, 1, adjustable='box')
        ax2 = plt.subplot(2, 2, 2, sharex=ax1, sharey=ax1, adjustable='box')
        ax3 = plt.subplot(2, 2, 3, sharex=ax1, sharey=ax1, adjustable='box')
...
def display_psf_fit(img, datamax=None):
    ...
    if os.path.isfile(ogfile) and os.path.isfile(rsfile):
        ...
        axL = plt.subplot(1, 3, 1, adjustable='box')
        axC = plt.subplot(1, 3, 2, sharex=axL, sharey=axL, adjustable='box')
        axR = plt.subplot(1, 3, 3, sharex=axL, sharey=axL, adjustable='box')
